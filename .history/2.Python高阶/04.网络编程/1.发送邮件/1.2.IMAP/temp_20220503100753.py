...
print(imapObj.search(['SINCE 02-May-2022', 'FROM 柯全飞']))  # 查看指定日期之后的邮件

rawMessages = imapObj.fetch([1589], ['BODY[]', 'FLAGS'])  # 查看指定邮件
message = pyzmail.PyzMessage.factory(rawMessages[1589][b'BODY[]'])  # 解析邮件
