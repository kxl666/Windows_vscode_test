...
rawMessages = imapObj.fetch([1588], ['BODY[]', 'FLAGS'])  # 查看指定邮件
message = pyzmail.PyzMessage.factory(rawMessages[1588][b'BODY[]'])  # 解析邮件
...
print(message.text_part.get_payload().decode('utf-8'))  # 查看邮件正文
imapObj.logout
