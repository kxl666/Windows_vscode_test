...
print(con.zrank('test', 'a'))  # 获取集合中指定元素的排名，从小到大排列

con.zincrby('test', 'a', amount=2)  # 对集合中指定元素的分数加上指定值
print(con.zscore('test', 'a'))

# con.zrem('test', 'a')  # 删除集合中指定元素
# print(con.zrange('test', 0, -1))

# con.zremrangebyrank('test', 0, 1)  # 删除集合中指定排名范围内的元素
# con.zremrangebyscore('test', 0, 10)  # 删除集合中指定分数范围内的元素