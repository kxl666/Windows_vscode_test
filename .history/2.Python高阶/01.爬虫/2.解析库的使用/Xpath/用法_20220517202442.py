...
# 10.xpath 属性|或的匹配
# result = html.xpath('//li[@class="item-0" or @class="item-1"]')
# print(result)
result = html.xpath('//li[@class="item-0"] | //li[@class="item-1"]')
print(result)
...
# 12.节点轴选择,，包括获取子元素 、兄弟元素、父元素、祖先元素等
...
# print(result)
# result = html.xpath('//li[1]/preceding::*')
# print(result)
