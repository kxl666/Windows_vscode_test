...
# print(doc('*#id-0').text())  # 不指定标签名,等同以下
# print(doc('#id-0').text())

# print(doc('li:not([id])'))  # 不含id的属性
# print(doc('li:not(.item-0)'))  # li中不含class为item-0的属性
# print(doc('li[id^=id]'))  # id以id开头的属性
# print(doc('li[class$=em-0]'))  # class以em-0结尾的属性
# print(doc('li[class*=item]'))  # class包含item的属性
# print(doc('p:contains(this-1)'))  # 包含this-1的属性
