...
from proxypool.utils.proxy import convert_proxy_or_proxies, is_valid_proxy

import redis

REDIS_CLIENT_VERSION = redis.__version__
IS_REDIS_VERSION_2 = REDIS_CLIENT_VERSION.startswith('2.')
REDIS_HOST = '45.43.61.98'
REDIS_PORT = 6379
REDIS_PASSWORD = 'Hbxs_tpp_123!_'
REDIS_DB = 0
REDIS_CONNECTION_STRING = 'redis://:{}@{}:{}/{}'.format(
