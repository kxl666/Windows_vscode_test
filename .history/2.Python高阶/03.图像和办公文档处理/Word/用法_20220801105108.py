...
doc.add_table(rows=1, cols=3,
              style='Table Grid').cell(0, 0).text = '新的表格'.style = 'Heading 1'
# 添加表格，并设置样式，并设置下划线
doc.add_table(rows=1, cols=3, style='Table Grid').cell(
    0, 0).text = '新的表格'.style = 'Heading 1'.add_run('新的段落').underline = True
# 添加表格，并设置样式，并设置粗体
doc.add_table(rows=1, cols=3, style='Table Grid').cell(
    0, 0).text = '新的表格'.style = 'Heading 1'.add_run('新的段落').bold = True
