...
# 2.设置文档样式
# 设置字体样式
doc.paragraphs[15].underline = True
doc.paragraphs[15].font.name = '宋体'
doc.paragraphs[15].font.size = docx.shared.Pt(20)
doc.paragraphs[15].font.bold = True
doc.paragraphs[15].font.italic = True
# 设置段落样式
doc.paragraphs[15].style.name = '标题'
