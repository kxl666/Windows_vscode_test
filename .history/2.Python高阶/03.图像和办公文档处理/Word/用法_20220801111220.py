import docx
from docx.enum.table import WD_ALIGN_PARAGRAPH, WD_CELL_VERTICAL_ALIGNMENT
...
# 垂直居中
t.cell(0, 0).paragraphs[0].alignment = WD_CELL_VERTICAL_ALIGNMENT.CENTER
# 水平居中
t.cell(0, 0).paragraphs[0].alignment = WD_ALIGN_PARAGRAPH.CENTER

# 添加图片
doc.add_picture('./File/test.png', width=Inches(1.25), height=Inches(1.25))
